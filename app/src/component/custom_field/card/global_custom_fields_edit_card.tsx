...
import { GlobeAltIcon, KeyIcon, PlusIcon, TrashIcon } from "@heroicons/react/24/solid";
...
const GlobalCustomFieldsEditCard = (props: Props) => {
...
export default GlobalCustomFieldsEditCard;